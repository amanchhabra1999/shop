...
<head>
<title>Power Technologies</title>
<link rel = "icon" href =  
"images\logo4.png" 
        type = "image/x-icon"> 
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
		<!--<li><a href="allproducts.php" class="nav2"> Products</a></li>
        <li class="divider"></li>-->
       
        <li class="divider"></li>
        <li><a href="allproducts.php" class="nav3">Products</a></li>
        <li class="divider"></li>
        ...
        <?php
         ...
         echo' <li ><a href="register.php"><button class="search_bt1" >Register</button></a></li>   
